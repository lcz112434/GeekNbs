 ...
 */
public class V2exPagerAdapter extends FragmentPagerAdapter {
    ArrayList<V2exTabBean> title;
    ArrayList<BaseFragment> mFragments;

    public V2exPagerAdapter(FragmentManager fm, ArrayList<V2exTabBean> title, ArrayList<BaseFragment> fragments) {
        super(fm);
        this.title = title;
